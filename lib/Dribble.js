        ...
        if (level_config[k].disabled !== true) {
            ...
            switch (k) {
                ...
                case 'console':
                    ...
                    // }
                    console.log(formatters[level_config[k].fileFormat || 'plain'](message, meta, log_date));
                    break;
                case 'file':
                    ...
                    var formatted_data = formatters[level_config[k].fileFormat || 'json'](message, meta, log_date);
